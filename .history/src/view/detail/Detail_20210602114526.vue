...
export default {
  ...
  computed: {
    ...
    //   aqiu: (state) => state.yukon.aqiu,
    //   yukon: (state) => state.yukon,
    // }),
  },
  methods: {
    ...mapActions(["addCart"]),
    ...
    addToCart() {
      ...
      if (obj.iid && obj.desc && obj.image && obj.nowPrice && obj.title) {
        this.addCart(obj).then((res) => {
          ...
          // let Arr = sessionStorage.getItem("cartList");
          // console.log(Arr.count);
          // console.log(...this.$store.state.cartList);
          // if (Arr.count) {
          //   this.$store.state.cartList.count += Arr.count;
          // }

          sessionStorage.setItem("cartData", JSON.stringify(this.cartList));
          ...
          // JSON.parse(sessionStorage.getItem("cartList")).push(
