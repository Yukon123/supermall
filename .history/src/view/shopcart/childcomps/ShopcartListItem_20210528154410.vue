  ...
  <div id="list-item">
    ...
    <div class="item-info">
      ...
      <div class="item-bottom">
        ...
        <div class="right add-button" @click="addMove">＋</div>
        <div class="item-count right">{{ item.count }}</div>
        <div class="right cut-button" @click="cutMove">－</div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    cutMove() {
      this.cutClick(this.item).then((res) => console.log(res));
    },
  },
  created() {},
  mounted() {},
